      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* Headline */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] mb-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              A Evolução da Gestão de Leads com{" "}
              <span className="text-gradient-primary">Inteligência Artificial Real</span>
            </h1>

            {/* Subheadline */}
            <p className="text-base md:text-lg text-muted-foreground mb-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-start gap-3 mb-6 animate-fade-in" style={{ animationDelay: "0.3s" }}>
