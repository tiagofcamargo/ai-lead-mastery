...
const plans = [
  ...
  { name: "Doctor Elite", price: "1.699", period: "/mês", description: "Para Escalar Vendas", icon: Rocket, stackedFrom: "CRC", features: ["Disparos Ilimitados", "3 Usuários", "9 NeuralChains", "Resgate Rápido", "Suporte Dedicado"], buttonText: "Escalar Vendas", buttonVariant: "elite" as const, popular: false, cardStyle: "border-secondary/50 bg-gradient-to-b from-secondary/5 to-transparent", link: "https://doctorai.com.br/login/register/711/MONTHLY?checkout=true" },
  { name: "Doctor Mestre SDR", price: "3.399", period: "/mês", description: "Potência Máxima", icon: Crown, stackedFrom: "Elite", features: ["Funil de Resgate (Neural Sales)", "CRM Kanban com IA", "120min de Clone de Voz", "12 NeuralChains"], buttonText: "Ativar Resgate", buttonVariant: "premium" as const, popular: false, cardStyle: "border-gold/30 bg-gradient-to-b from-gold/5 to-transparent", link: "https://doctorai.com.br/login/register/714/MONTHLY?checkout=true" },
];
